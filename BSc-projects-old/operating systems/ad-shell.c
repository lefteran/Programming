/*
 *    adsh: 	this is a small shell that uses execvp and can execute 
 * 		simple shell commands.
 *
 *    author: 	A. Delis ad@di.uoa.gr 
 *    date:	April 2002
 *
 *   	You can use parts of the code but before you do so make 
 * 	sure you understand what you (and the code) are doing. 
 * 	Check the manual pages for the system calls: execvp, wait, and fork.
*/
